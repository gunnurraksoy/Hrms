...
public class LanguageManager implements LanguageService {
	...
	@Override
	public DataResult<List<Language>> findAllByCandidate_Id(int candidateId) {
		return new SuccessDataResult<List<Language>>(languageDao.findAllByCandidate_Id(candidateId));
	}
